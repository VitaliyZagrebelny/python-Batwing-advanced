...
def product_details(request, id):
    ...
    if product.id in request.sesion.get("products", []):
        return render(request, "products/details.html",
                      {"product": product, "button_status": "btn btn-secondary btn-lg"})
    return render(request, "products/details.html", {"product": product, "button_status": "btn btn-lg btn-primary"})
